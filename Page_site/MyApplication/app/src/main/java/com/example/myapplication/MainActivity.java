...
public class MainActivity extends AppCompatActivity {
    ...
    //Liste de sort
        //totale
    ArrayList SkillsTotal = new ArrayList();
        //choisis
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Liste de Spels                    //récupéré depuis DB
            //totale
        SkillsTotal.add("Boule de feu");
        SkillsTotal.add("Boost");
        SkillsTotal.add("pic");
        SkillsTotal.add("Griffe");
        SkillsTotal.add("pied");
        SkillsTotal.add("jambe");
        SkillsTotal.add("bassin");
        SkillsTotal.add("Corps");
            //choisis
    ...
    public void GenerationStatHero()
    {
        PvHero = 300;
        HeroName ="Jean";
        ...
        Heroarmuremag_plus =5;
        Heroarmuremag_mult =1.3;

        Herodegat_plus =5;
        Herodegat_multp=1.2;

        Herodegatmag_plus=10;
        Herodegatmag_multp=0.8;
