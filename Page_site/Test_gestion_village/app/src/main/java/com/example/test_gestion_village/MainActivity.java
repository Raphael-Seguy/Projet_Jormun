package com.example.test_gestion_village;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void Generation_village()
    {
        ...
        if(ListBat.size()>=1)
        {
            ...
            bnt_bat0.setText(SetNameBat(batactu));
            ...
            if(ListBat.size()>=2)
            {
                ...
                bnt_bat1.setText(SetNameBat(batactu));
                ...
                if(ListBat.size()>=3)
                {
                    ...
                    bnt_bat2.setText(SetNameBat(batactu));
                    ...
                    if (ListBat.size()>=4)
                    {
                        ...
                        bnt_bat3.setText(SetNameBat(batactu));
                        ...
                        if(ListBat.size()>=5)
                        {
                            ...
                            bnt_bat4.setText(SetNameBat(batactu));
    ...
    public void AffichBatprec(final int Batplace, final Button btnCible, final Batiment bat)
    {
        btnCible.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Nom_bat.setText(SetNameBat(bat)+ " " +bat.lvl);
...
;                }
    ...
    public void SetColorBat(Button btn_bat, Batiment bat_actu,ArrayList invress)    ////affiche si possible de LvlUp avec ressource actu
    {
        ...
        if(up_ok==true)
        {
            btn_bat.setBackgroundColor(Color.rgb(0,100,0));
        }
    }
    ...
    public ArrayList FauxInvRes()
    {
        ...
        InvRes.add(FausseRessource("Bois",15));
