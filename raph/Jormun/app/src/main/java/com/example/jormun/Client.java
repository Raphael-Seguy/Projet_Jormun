...
public class Client{
    ...
    public Client(String sIp, int iPort, String sToken,LatLng Center, LatLng FRCORNER, LatLng FLCORNER, LatLng NRCORNER, LatLng NLCORNER){
        ...
        rnbleUserReceiver = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    do {
                        sData = dtinstrmBackToClient.readUTF();
                        if(sData.contains("@") && sData.contains("#")) {
                            ...
                            if(CheckToken(sUsertk)) {
                                getAl_ousrUser().get(GetIndexOf(sUsertk)).setfPosX(fLat);
                                getAl_ousrUser().get(GetIndexOf(sUsertk)).setfPosY(fLong);
                            }else {
