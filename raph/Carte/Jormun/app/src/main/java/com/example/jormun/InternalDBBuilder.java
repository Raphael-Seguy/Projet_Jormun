...
public class InternalDBBuilder extends SQLiteOpenHelper {
    ...
    public static final String COL_worldmapmin_OBJECTREF = "OBJECTREF";
    public static final String COL_worldmapmin_IDREF = "IDREF";
    public static final String COL_worldmapmin_IDOLDREF = "IDOLDREF";
    public static final String COL_worldmapmin_TOKENREF = "TOKENREF";
    public static final String COL_worldmapmin_ELEMENTKEY = "ELEMENTKEY";
...
*/  //TABLE monster
    ...
    public static final String COL_structure_IDSTRUCTURE = "IDSTRUCTURE";
    public static final String COL_structure_PATHJSON = "PATHJSON";
    public static final String COL_structure_TOKEN = "TOKEN";
...
*/
    ...
    public void InitializeTables(SQLiteDatabase db) {
        String[] a_sDatabase = {TABLE_infouser, TABLE_worldmapmin, TABLE_village, TABLE_monster, TABLE_hero, TABLE_currentteam,TABLE_structure};
        ...
        switch (sTable) {
            ...
            case TABLE_worldmapmin:
                sAnswer = "CREATE TABLE if not exists " + TABLE_worldmapmin + "(" +
                        ...
                        COL_worldmapmin_OBJECTREF + " VARCHAR(255) NOT NULL," +
                        COL_worldmapmin_IDOLDREF+" INTEGER,"+
                        COL_worldmapmin_IDREF + " INTEGER,"+
                        COL_worldmapmin_TOKENREF + " VARCHAR(255),"+
                        COL_worldmapmin_ELEMENTKEY+ " VARCHAR(255));";
                break;
            case TABLE_structure:
                sAnswer = "CREATE TABLE if not exists " + TABLE_structure + "(" +
                        COL_structure_IDSTRUCTURE + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                        COL_structure_PATHJSON + " VARCHAR(255) NOT NULL," +
                        COL_structure_TOKEN + " VARCHAR(255) references " + TABLE_infouser + "(" + COL_infouser_TOKEN + ") ON UPDATE CASCADE ON DELETE CASCADE);";
                break;
            default:
                sAnswer="";
                break;
