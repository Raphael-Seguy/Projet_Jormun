...
public class ActivityBase extends AppCompatActivity {
    ...
    public void GenerationHero() //Recupération info des trois premiers héros
    {
        ...
        SpriteHero0.setBackgroundResource(hero.Image);
        SpriteHero0.setText("");
        ...
        if(ListHeros.size()>=2)
        {
            ...
            SpriteHero1.setBackgroundResource(hero.Image);
            SpriteHero1.setText("");
            ...
            if(ListHeros.size()>=3)
            {
                ...
                SpriteHero2.setBackgroundResource(hero.Image);
                SpriteHero2.setText("");
    ...
    {
        Hero heroactu = (com.example.projet_jormun.Hero) ListHeros.get(Hero);
    ...
    public void GetInv(ArrayList inventaire, final int hero)
    {
        ...
        for (int Compteur=0; Compteur<inventaire.size();Compteur++)
        {
            ...
            test.setBackgroundResource(Current_item.Image);                                      ////////image de l'item
            test.setHeight(300);
            test.setWidth(300);
    ...
    public void affichItemFiche(final Item objet, final int hero)
    {
        ...
        Sprite_inv_prec.setImageResource(objet.Image);
    ...
    public void GenerationQuete()
    {
        ...
        for (int compteur=0;compteur<ListQuet.size();compteur++)
        {
            ...
            btn_rec.setBackgroundResource(currentQuest.recompense.Image);
    ...
    public void AffichRec(Item recomp)
    {
        ...
        Sprite_rec.setImageResource(recomp.Image);
    ...
    public void GenerationRess()
    {
        ...
        for (int compteur=0;compteur<ListRess.size();compteur++)
        {
            ...
            btn_rec.setHeight(450);
            btn_rec.setWidth(500);
            btn_rec.setBackgroundResource(currentRess.image);
    ...
    public void openActivityEquipement(int place) {
        ...
        Hero actuHero = (com.example.projet_jormun.Hero) ListHeros.get(place);
        intent.putExtra("hero", actuHero);
        intent.putExtra("ListeSkils",actuHero.SkillTotal);
        intent.putExtra("SkillsChoisis",actuHero.SkillChoisis);
