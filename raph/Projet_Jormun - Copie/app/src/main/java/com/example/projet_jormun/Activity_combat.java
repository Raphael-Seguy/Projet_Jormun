...
public class Activity_Combat extends AppCompatActivity
{
    ...
    //recupération des modificateur du hero défini par son équipement de base
    //armure
    private int Equiparmure_plus;
    private double Equiparmure_mult;
    //armure magique
    private int Equiparmuremag_plus;
    private double Equiparmuremag_mult;
    //esquive
    private int Equipesquive_plus;
    private double Equipesquive_mult;
    //degat
    private int Equipdegat_plus;
    private double Equipdegat_multp;
    //degat magique
    private int Equipdegatmag_plus;
    private double Equipdegatmag_multp;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        SpriteHero.setImageResource(R.drawable.liche);
        SpriteMob.setImageResource(R.drawable.loup);
                    ...
                    public void onClick(View v) {
                        if(PlayerTurn==true)
                        {
                            ...
                            if(Spel0Type%3==0) //bonus
                            {
                                ...
                                if(Spel0Bon_armure_mult !=0)
                                {
                                    Heroarmure_mult = Heroarmure_mult + Spel0Bon_armure_mult;
                    ...
                    public void onClick(View v) {
                        if(PlayerTurn==true)
                        {
                            ...
                            if(Spel1Type%3==0) //bonus
                            {
                                ...
                                if(Spel1Bon_armure_mult !=0)
                                {
                                    Heroarmure_mult = Heroarmure_mult + Spel1Bon_armure_mult;
                    ...
                    public void onClick(View v) {
                        if (PlayerTurn==true)
                        {
                            ...
                            if(Spel2Type%3==0) //bonus
                            {
                                ...
                                if(Spel2Bon_armure_mult !=0)
                                {
                                    Heroarmure_mult = Heroarmure_mult + Spel2Bon_armure_mult;
                    ...
                    public void onClick(View v) {
                        if (PlayerTurn==true)
                        {
                            ...
                            if(Spel3Type%3==0) //bonus
                            {
                                ...
                                if(Spel3Bon_armure_mult !=0)
                                {
                                    Heroarmure_mult = Heroarmure_mult + Spel3Bon_armure_mult;
                    ...
                    public void onClick(View v) {
                        if(PlayerTurn==true)
                        {
                            ...
                            if(Objet0Type%3==0) //bonus
                            {
                                ...
                                if(Objet0Bon_armure_mult !=0)
                                {
                                    Heroarmure_mult = Heroarmure_mult + Objet0Bon_armure_mult;
                                }
                                if(Objet0Bon_armuremag_plus !=0)
                                {
                                    Heroarmuremag_plus = Heroarmuremag_plus + Objet0Bon_armuremag_plus;
                    ...
                    public void onClick(View v) {
                        if(PlayerTurn==true)
                        {
                            ...
                            if(Objet1Type%3==0) //bonus
                            {
                                ...
                                if(Objet1Bon_armure_mult !=0)
                                {
                                    Heroarmure_mult = Heroarmure_mult + Objet1Bon_armure_mult;
                                }
                                if(Objet1Bon_armuremag_plus !=0)
                                {
                                    Heroarmuremag_plus = Heroarmuremag_plus + Objet1Bon_armuremag_plus;
                    ...
                    public void onClick(View v) {
                        if(PlayerTurn==true)
                        {
                            ...
                            if(Objet2Type%3==0) //bonus
                            {
                                ...
                                if(Objet2Bon_armure_mult !=0)
                                {
                                    Heroarmure_mult = Heroarmure_mult + Objet2Bon_armure_mult;
                                }
                                if(Objet2Bon_armuremag_plus !=0)
                                {
                                    Heroarmuremag_plus = Heroarmuremag_plus + Objet2Bon_armuremag_plus;
                    ...
                    public void onClick(View v) {
                        if(PlayerTurn==true)
                        {
                            ...
                            if(Objet3Type%3==0) //bonus
                            {
                                ...
                                if(Objet3Bon_armure_mult !=0)
                                {
                                    Heroarmure_mult = Heroarmure_mult + Objet3Bon_armure_mult;
                                }
                                if(Objet3Bon_armuremag_plus !=0)
                                {
                                    Heroarmuremag_plus = Heroarmuremag_plus + Objet3Bon_armuremag_plus;
    ...
    {
        Heroarmure_plus = Equiparmure_plus;
        Heroarmuremag_plus =Equiparmuremag_plus;
        if(Tourdef>0)
        {
            Heroarmure_mult =Equiparmure_mult+1;
            Heroarmuremag_mult =Equiparmuremag_mult+1;
        }
        else
        {
            Heroarmure_mult =Equiparmure_mult;
            Heroarmuremag_mult =Equiparmuremag_mult;
            seDefend = false;
        }
        Herodegat_plus=Equipdegat_plus;
        Herodegat_multp=Equipdegat_multp;
        Herodegatmag_plus=Equipdegatmag_plus;
        Herodegatmag_multp=Equipdegatmag_multp;
        Heroesquive_plus =Equipesquive_plus;
        Heroesquive_mult=Equipesquive_mult;
    }
    ...
    public void InitialisationHero()
    {
        maxhpHero = 400;
        ...
        degatHero = 20;
        esquiveHero = 80;
        //set des bonus définis par l'équipement du héro (DB)
        Equiparmure_plus = 20;
        Equiparmure_mult =1;
        Equiparmuremag_plus=5;
        Equiparmuremag_mult=1.2;
        Equipdegat_plus =10;
        Equipdegat_multp=1;
        Equipdegatmag_plus =8;
        Equipdegatmag_multp=1.0;
        Equipesquive_plus=10;
        Equipesquive_mult=1;
        //initialisation des bonus en fonction de l'equipement
        resetBonus();
